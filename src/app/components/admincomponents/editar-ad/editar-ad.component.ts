...
@Component({
  selector: 'app-editar-ad',
  templateUrl: './editar-ad.component.html',
  styleUrls: ['./editar-ad.component.css']
})
export class EditarAdComponent implements OnInit{
    ...
    if (this.userForm && this.userForm.valid) {
      this.usr.updateUserById(this.id_user, this.userForm.value).subscribe(
        () => {
          ...
          this.goodNot();
          this.router.navigate(['homeadmin/administrators']);
